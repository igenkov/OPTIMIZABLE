...
export const BIOMARKERS: BiomarkerDef[] = [
  ...
  { id: 'free_t3', name: 'Free T3', unit_primary: 'pg/mL', standard_range_low: 2.3, standard_range_high: 4.2, optimal_range_low: 3.0, optimal_range_high: 4.0, description: 'Active thyroid hormone — low levels impair testosterone production', category: 'thyroid' },
  { id: 'free_t4', name: 'Free T4', unit_primary: 'ng/dL', standard_range_low: 0.8, standard_range_high: 1.8, optimal_range_low: 1.0, optimal_range_high: 1.6, description: 'Thyroid hormone — dysfunction mimics low testosterone symptoms', category: 'thyroid' },
  ...
  { id: 'fasting_insulin', name: 'Fasting Insulin', unit_primary: 'mU/L', standard_range_low: 2.6, standard_range_high: 24.9, optimal_range_low: 2.6, optimal_range_high: 10, description: 'Chronic hyperinsulinemia suppresses testosterone and raises SHBG', category: 'metabolic' },
  { id: 'hba1c', name: 'HbA1c', unit_primary: '%', standard_range_low: 4.0, standard_range_high: 5.6, optimal_range_low: 4.0, optimal_range_high: 5.2, description: 'Long-term glucose control marker; elevated levels correlate with low testosterone', category: 'metabolic' },
  { id: 'hdl', name: 'HDL Cholesterol', unit_primary: 'mg/dL', standard_range_low: 40, standard_range_high: 100, optimal_range_low: 60, optimal_range_high: 100, description: 'Protective cholesterol; low HDL is associated with androgen deficiency', category: 'lipids' },
  { id: 'ldl', name: 'LDL Cholesterol', unit_primary: 'mg/dL', standard_range_low: 0, standard_range_high: 130, optimal_range_low: 0, optimal_range_high: 100, description: 'Cardiovascular risk marker; cholesterol is a precursor to testosterone', category: 'lipids' },
  { id: 'triglycerides', name: 'Triglycerides', unit_primary: 'mg/dL', standard_range_low: 0, standard_range_high: 150, optimal_range_low: 0, optimal_range_high: 100, description: 'Elevated triglycerides indicate insulin resistance and correlate with low testosterone', category: 'lipids' },
  ...
  { id: 'albumin', name: 'Albumin', unit_primary: 'g/dL', standard_range_low: 3.5, standard_range_high: 5.0, optimal_range_low: 4.0, optimal_range_high: 5.0, description: 'Required to calculate free testosterone accurately', category: 'metabolic' },
  { id: 'coq10', name: 'CoQ10 (Coenzyme Q10)', unit_primary: 'mcg/mL', standard_range_low: 0.5, standard_range_high: 1.7, optimal_range_low: 1.0, optimal_range_high: 1.7, description: 'Depleted by statin medications; essential for mitochondrial energy and testosterone synthesis', category: 'metabolic' },
  { id: 'cortisol_am', name: 'Morning Cortisol', unit_primary: 'mcg/dL', standard_range_low: 6, standard_range_high: 23, optimal_range_low: 10, optimal_range_high: 20, description: 'Elevated AM cortisol drives pregnenolone steal — diverts testosterone building blocks toward stress hormones', category: 'hormones' },
  { id: 'psa', name: 'PSA (Prostate-Specific Antigen)', unit_primary: 'ng/mL', standard_range_low: 0, standard_range_high: 4.0, optimal_range_low: 0, optimal_range_high: 2.5, description: 'Mandatory monitoring on TRT — androgenic stimulation can accelerate prostate tissue growth', category: 'metabolic' },
  { id: 'ferritin', name: 'Ferritin', unit_primary: 'ng/mL', standard_range_low: 12, standard_range_high: 300, optimal_range_low: 50, optimal_range_high: 150, description: 'Iron storage marker — elevated ferritin (hemochromatosis) deposits iron in the pituitary and testes, directly suppressing testosterone production', category: 'metabolic' },
];
