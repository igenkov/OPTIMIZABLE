...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* Brand column — desktop: fixed height column; mobile: compact top */}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between gap-2">
                  <label className="text-[8px] font-black uppercase tracking-[0.18em] text-white/40">Access Key</label>
                  <Link
                    href="/forgot-password"
                    className="shrink-0 text-[8px] font-black uppercase tracking-[0.14em] text-[#C8A2C8]/70 transition-colors hover:text-[#C8A2C8]"
                  >
                    Recovery?
                  </Link>
                </div>
              ...
              >
                {!loading && (
                  <>
                    Authorize Session <Fingerprint size={16} aria-hidden />
                  </>
                )}
              </Button>
            </form>
