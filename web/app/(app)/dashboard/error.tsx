...
export default function DashboardError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="p-8 max-w-xl">
      <div className="border border-[rgba(232,128,128,0.3)] bg-[rgba(232,128,128,0.05)] p-6">
        <div className="text-xs font-bold text-[#E88080] tracking-widest uppercase mb-2">Dashboard Error</div>
