...
export default function UploadPage() {
  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="mb-8">
        <h1 className="text-lg font-bold tracking-[3px] uppercase text-white mb-2">Upload Bloodwork</h1>
        <p className="text-sm text-[#9A9A9A]">Enter your lab values to get your AI-powered analysis and Testosterone Health Score.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <Card accent>
          <div className="text-[10px] font-bold tracking-[3px] text-[#00E676] uppercase mb-3">Important: Timing Note</div>
        ...
        <Button type="submit" loading={uploading} fullWidth disabled={filled.length < 3}>
          {uploading ? 'Saving...' : 'ANALYZE MY BLOODWORK →'}
        </Button>
      </form>
    </div>
  );
