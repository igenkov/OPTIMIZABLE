    ...
    <div className="w-full min-w-0">
      ...
      <div className="mt-6 sm:mt-7">
        <div className="mb-3 flex items-center justify-between gap-4">
          <span className="text-[8px] font-black uppercase tracking-[0.2em] text-[#77717a]">Baseline</span>
  ...
  return (
    <div className="min-h-[100dvh] bg-[#0e0e0e] text-white flex flex-col">
      ...
      <main className="relative z-10 flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-12 py-8 sm:py-10 lg:py-6">
        <div className="w-full max-w-7xl mx-auto flex flex-col gap-7 sm:gap-8 lg:gap-9">
          <section className="flex flex-col sm:flex-row gap-2.5 w-full sm:w-auto" aria-label="Primary actions">
            <Link
