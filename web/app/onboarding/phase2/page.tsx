...
export default function Phase2Page() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    await supabase.from('lifestyle').upsert({ user_id: user.id, ...form });
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <Card>
          ...
          <SelectRow label="Alcohol" value={form.alcohol_frequency} onChange={v => set('alcohol_frequency', v)}
            options={[{label:'Never',value:'never'},{label:'Rarely',value:'rarely'},{label:'Moderate',value:'moderate'},{label:'Frequent',value:'frequent'},{label:'Daily',value:'daily'}]} />
        ...
        <Card>
          ...
          <SelectRow label="Sexual frequency" value={form.sexual_frequency} onChange={v => set('sexual_frequency', v)}
            options={[{label:'Rarely',value:'rarely'},{label:'1-2x/mo',value:'1-2x_month'},{label:'1-2x/wk',value:'1-2x_week'},{label:'3-4x/wk',value:'3-4x_week'},{label:'Daily',value:'daily'}]} />
